        ...
        for(String key : paramMap.keySet()) {
            ...
            if(key.startsWith(PARAM_PRE)) {
                try {
                    ...
                    String[] val_array = new String[50];
                    if(StringUtils.contains(parVal,"eq")){
                        val_array = parVal.split(PARAM_SPE);
                    }else{
                        String  valall = parVal.substring(5,parVal.length());
                        String vallike = "like"+","+valall;
                        val_array = vallike.split(",");
                    }
